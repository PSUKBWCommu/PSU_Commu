    ...
    return (
      ...
      <NavigationEvents
        ...
        <ScrollView>
          ...
          <Text style={styles.text}>วันที่ต้องการเริ่มจอง : {this.state.use_date}</Text>
          <Text style={styles.text}>จำนวนวัน : {this.state.num_date}</Text>
          <Text style={styles.text}>วันกำหนดคืน : {this.state.appoint_date}</Text>
          <Text style={styles.text}>จำนวนเครื่องที่ต้องการจอง : {this.state.num_machine}</Text>
