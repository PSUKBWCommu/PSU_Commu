...
export default class NFRL_Reserve_EditScreen extends React.Component {

  static navigationOptions = ({ navigation }) => ({
    title: 'NFRL - ReserveEdit',
    headerStyle: {
      ...
      <View style={styles.container}>
        <ScrollView>
          ...
          <TextInput 
            ...
            onChangeText={(num_date) => this.setState({ num_date })}
